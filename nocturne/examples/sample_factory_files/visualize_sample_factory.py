...
'''
HOW TO RUN:
python3 visualize_sample_factory.py /cluster/research-groups/ramasubramanian/workspace/duncanj5/nocturne/examples/sample_factory_files/train/EXPERIMENT_NAME_3/
python3 visualize_sample_factory.py /cluster/research-groups/ramasubramanian/workspace/duncanj5/nocturne/examples/sample_factory_files/train/EXPERIMENT_NAME_4/
'''
...
def run_eval(cfg_dict, max_num_frames=1e9):
    ...
    if render_action_repeat is None:
        ...
        render_action_repeat = 100 # SEEMS TO CHANGE A LOT
    log.debug('Using action repeat %d during evaluation', render_action_repeat)

    cfg.env_frameskip = 1  # for evaluation
    cfg.num_envs = 1
    cfg.seed = 423 #np.random.randint(10000) good ones: 1
